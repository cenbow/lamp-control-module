...
/**
 * <p>Title: IIotWallLightService</p>
 * <p>Description: 洗墙灯灯指令下发接口</p>
 * <p>
 * 0x0601: 创建终端所带的片选器参数
 * 0x0602: 实时调整节目模式
 * 0x0603: 实时调整颜色和亮度模式
 * 0x0604: 设置终端定时调色和亮度策略
 * 0x0605: 设置终端定时节目策略
 * 0x0606: 设置开机自动运行节目模式
 * 0x0610: 查询终端所带的片选器参数
 * </p>
 ...
 */
public interface IIotWallLightService extends IBaseDeviceService {
     ...
     */
    IRespCode sendWallCmd601(String deviceId, ParamWallCmd601 param) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd602(String deviceId, ParamWallCmd602 param) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd603(String deviceId, ParamWallCmd603 param) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd604(String deviceId, ParamWallCmd604 param) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd605(String deviceId, ParamWallCmd605 param) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd606(String deviceId) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd610(String deviceId) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd611(String deviceId) throws YcException;
     ...
     * @throws YcException 自定义异常
     */
    IRespCode sendWallCmd612(String deviceId) throws YcException;
}
